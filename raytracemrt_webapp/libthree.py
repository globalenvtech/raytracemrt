...
# JS: import { TrackballControls } from 'tc';
from pyscript.js_modules.tc import TrackballControls

# JS: import Stats from 'stats';
from pyscript.js_modules.stats import default as Stats
...
def get_renderer():
    ...
    right_side = document.getElementById('rightSide')
    right_side.appendChild(renderer.domElement)
